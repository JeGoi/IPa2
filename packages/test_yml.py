...
def test_program(out,yml):
    op = 'Program'
    obligations = ['name','exitValue','executablePaths','menu','numImputs','outputPath']
    warnings    = ['website','helpSupplementary','publication','desc','webServices','outputFilesFromOutputPath']
